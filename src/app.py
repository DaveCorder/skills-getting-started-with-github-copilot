...
activities = {
    ...
    "Swimming Club": {
        "description": "Improve swimming technique and compete in meets",
    ...
    "Drama Workshop": {
        "description": "Practice acting, improv, and stagecraft for school productions",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["chloe@mergington.edu", "liam@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build critical thinking and public speaking skills through debate competitions",
        "schedule": "Wednesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["sophia@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science challenges and team competitions in STEM subjects",
